...
// import styles from './pronounVerbData.module.scss';
import { IPropsPronounVerbData } from './model';

const PronounVerbData: FC<IPropsPronounVerbData> = ({
  id,
  pronoun,
  pronounTranslation,
  saveVerbHandler,
...
export default PronounVerbData;
